                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center" style="width: 30%;">
                                <form role="form" action="{{route('admin.department.update')}}" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                ...
                                <button type="submit" name="add_deparment" class="btn btn-info">Update Department</button>
                            </form>
                            </div>
