...
<div class="container table-responsive" style="padding-top: 20px;">
        <div >
            <a style="display: inline;float: left;margin-right: 40px" class="btn btn-primary" href="{{route('admin.department.index')}}">Back<i></i></a>
             <br><br><br>
            <h1 style="text-align: center;">Manager List Deleted Department </h1>
            <br>
             <?php
